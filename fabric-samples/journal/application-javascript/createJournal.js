...
async function createJournal(ccp,wallet,user,journalID) {
    try {
      ...
      await gateway.connect(ccp,
        ...
        let statefulTxn = contract.createTransaction('CreateJournal');

        console.log('\n--> Submit Transaction: Create a new journal');
        await statefulTxn.submit(journalID);
...
async function main() {
    try {
        ...
        if (org == 'Org1' || org == 'org1') {
            ...
            await createJournal(ccp,wallet,user,journalID);
        }
